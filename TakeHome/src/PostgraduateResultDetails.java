 ...
 * @author jinthu
 */
public class PostgraduateResultDetails extends javax.swing.JFrame {

    /**
     * Creates new form PostgraduateResultDetails
     */
    public PostgraduateResultDetails() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        addResults.setBackground(new java.awt.Color(40, 162, 226));
        ...
        updateResults.setBackground(new java.awt.Color(40, 162, 226));
        updateResults.setFont(new java.awt.Font("Lato", 1, 15)); // NOI18N
        updateResults.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        this.hide();
        PostgraduateResultsMain student = new PostgraduateResultsMain();
    ...
    private void addResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addResultsActionPerformed
        this.hide();
        PostgraduateAddResults result = new PostgraduateAddResults();
    ...
    private void updateResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateResultsActionPerformed
        this.hide();
        UpdatePostgraduateResults result = new UpdatePostgraduateResults();
        result.setVisible(true);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostgraduateResultDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostgraduateResultDetails().setVisible(true);
            }
        });
    }
