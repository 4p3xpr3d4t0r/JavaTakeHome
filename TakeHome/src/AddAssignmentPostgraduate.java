 ...
 * @author jinthu
 */
public class AddAssignmentPostgraduate extends javax.swing.JFrame {

    /**
     * Creates new form AddAssignmentPostgraduate
     */
    public AddAssignmentPostgraduate() {
        initComponents();
    }
    ...
    private void addResultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addResultActionPerformed
        try{
            ...
            String query = "insert into postgraduateassignment(indexNo,title,number,results)values(?,?,?,?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAssignmentPostgraduate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddAssignmentPostgraduate().setVisible(true);
            }
        });
    }
